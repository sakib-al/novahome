...
class FrontendController extends Controller
{
    ...
    public function generalStore(Request $request){
        ...
        if($request->hasFile('logo')){
            ...
            //dd(Storage::disk(env('FILE_DISK'))->exists('/uploads/info/' . \Info::Settings('general', 'logo')));
            // Delete Old
            if(\Info::Settings('general', 'logo')){
                if(Storage::disk(env('FILE_DISK'))->exists('/uploads/info/' . \Info::Settings('general', 'logo'))){
                    $img_del = '/uploads/info/' . \Info::Settings('general', 'logo');
                    Storage::disk(env('FILE_DISK'))->delete($img_del);
                }
        ...
        if($request->hasFile('favicon')){
           ...
           // dd(Storage::disk(env('FILE_DISK'))->exists('/uploads/info/' . \Info::Settings('general', 'favicon')));
            // Delete Old
            if(\Info::Settings('general', 'favicon')){
                if(Storage::disk(env('FILE_DISK'))->exists('/uploads/info/' . \Info::Settings('general', 'favicon'))){
                    $img_del = '/uploads/info/' . \Info::Settings('general', 'favicon');
                    Storage::disk(env('FILE_DISK'))->delete($img_del);
                }
        ...
        if($request->hasFile('og_image')){
            ...
            if(\Info::Settings('general', 'og_image')){
                if(Storage::disk(env('FILE_DISK'))->exists('/uploads/info/' . \Info::Settings('general', 'og_image'))){
                    $img_del = '/uploads/info/' . \Info::Settings('general', 'og_image');
                    Storage::disk(env('FILE_DISK'))->delete($img_del);
                }
        ...
        if($request->hasFile('hb_background')){
            $this->validate($request, [
            ...
            if(\Info::Settings('home_banner', 'background')){
                $img_del = '/uploads/info/' . \Info::Settings('home_banner', 'background');
                if(Storage::disk(env('FILE_DISK'))->exists($img_del)){
                    Storage::disk(env('FILE_DISK'))->delete($img_del);
                }
            }
