        ...
        <div class="row border" v-for="(item,key) in items" :key="key">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="join_type[]" class="form-control" placeholder="join type" type="text" required>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
            ...
            <div class="col-sm-3" v-if="parseInt(item.payment_type) === 0">
                <div class="form-group">
                    ...
                    <input :name="'amount['+key+']'" class="form-control" placeholder="amount here" type="number" step="any" required>
                </div>
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-3" v-if="parseInt(item.join_limit) === 1">
                <div class="form-group">
                    ...
                    <input :name="'limit['+key+']'" class="form-control" placeholder="join limit" type="number" step="any" required>
                </div>
            </div>
                ...
                <div class="row" >
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input :name="'label['+key+']['+key2+']'" class="form-control" placeholder="lable write here" type="text" required>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label><b>Name</b></label>
                            <input :name="'input_name['+key+']['+key2+']'" class="form-control" placeholder="input name write here" type="text" required>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        ...
                        <div class="row col-md-12" v-for="(op,key3) in itm.options" :key="key3">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input :name="'value['+key+']['+key2+'][]'" class="form-control" v-model="op.name" placeholder="option here" type="text" required>
                                </div>
                            </div>
                            <!-- Remove Button -->
                            <div class="col-sm-1">
