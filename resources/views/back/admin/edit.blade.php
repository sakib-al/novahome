...
<div class="card">
    <div class="card-header">
        <a href="{{route('back.admins.index')}}" class="btn btn-success btn-sm"><i class="fas fa-angle-double-left"></i> View All</a>
        <a href="{{route('back.admins.create')}}" class="btn btn-info btn-sm"><i class="fas fa-plus"></i> Create</a>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <div class="img_group">
                                    ...
                                    @else
                                    <img class="img-thumbnail uploaded_img" src="{{env('AWS_URL').'/img/default-img.png'}}">
                                    @endif

                                    @if($user->profile_image)
                                    <a href="{{route('back.admins.removeImage', $user->id)}}" onclick="return confirm('Are you sure to remove?');" class="btn btn-sm btn-danger remove_image" title="Remove image"><i class="fas fa-times"></i></a>
                                    @endif
